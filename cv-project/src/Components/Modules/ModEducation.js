    ...
    <div className="form">
      <div className="column">
        ...
        <input
          ...
          name="educationName"
          className="education"
          value={props.educationName}
          onChange={props.changeEducation}
          id={props.moduleID}
        />
      </div>
      <div className="column">
        <label className="weight--slight">Degree or Certificate</label>
        <input
          type="text"
      ...
      <div className="row between">
        <div className="column duo">
          ...
          <select
            id={props.moduleID}
            value={props.educationStarting}
            name="educationStarting"
            onChange={props.changeEducation}
          >
        ...
        <div className="column duo">
          ...
          <select
            id={props.moduleID}
            onChange={props.changeEducation}
            value={props.educationEnding}
            name="educationEnding"
          >
            <option value="">YYYY</option>
            <option value="2022">2022</option>
            <option value="2021">2021</option>
